from mne.roots.closed_methods import root_false_position, root_bisection, root_false_position_mod, StopOption
...
def main2():
    ...
    res = root_false_position(f, x1, x2, _rel_err=0.01, max_iterations=42, option=StopOption.ITERATIONS)
    print(res.to_str(xt))
    print()
